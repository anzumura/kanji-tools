...
TEST_F(FileStatsTest, PrintStatsForOneDirectory) {
  ...
  const char* expected[] = {
    ...
    ">>>            Extra:     38, unique:   17,   0.08%  (妾 4, 蝕 4, 邯 4, 鄲 4, 哭 3)",
    ">>>             None:    159, unique:   97,   0.35%  (婬 18, 剪 10, 畸 9, 滸 4, 薛 3)",
...
TEST_F(FileStatsTest, PrintStatsForMultipleDirectories) {
  ...
  const char* expected[] = {
    ...
    ">>>            Extra:    115, unique:   39,   0.15%  (掻 12, 妾 6, 怯 5, 攫 5, 朧 5)",
    ">>>             None:    619, unique:  286,   0.82%  (厭 34, 婬 18, 拵 12, 椒 11, 剪 10)",
