...
public:
  ...
  [[nodiscard]] const std::string& meaning() const override { return _link->meaning(); }
  [[nodiscard]] const std::string& reading() const override { return _link->reading(); }
...
protected:
  ...
  [[nodiscard]] static auto& checkType(const std::string& name, const Data::Entry& link, bool isJinmei = false) {
...
public:
  ...
  [[nodiscard]] KanjiTypes type() const override { return KanjiTypes::LinkedJinmei; }
};
...
public:
  ...
  [[nodiscard]] KanjiTypes type() const override { return KanjiTypes::LinkedOld; }
};
