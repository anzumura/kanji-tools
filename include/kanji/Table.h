...
public:
  ...
  // Note, a value containing a pipe (|) character will mess up rendering the table so these
  // characters are escaped, but no other accommodations are done for markdown (like checking for
